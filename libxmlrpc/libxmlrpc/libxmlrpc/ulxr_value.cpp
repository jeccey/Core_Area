...
ULXR_API_IMPL0 Value::Value (CppString n, const Boolean &val)
{
   boolVal = new Boolean(val);
   name = n;
}
...
ULXR_API_IMPL0 Value::Value (CppString n, const Integer &val)
{
   intVal = new Integer(val);
   name = n;
}
...
ULXR_API_IMPL0 Value::Value (CppString n, const Double &val)
{
   doubleVal = new Double(val);
   name = n;
}
...
ULXR_API_IMPL0 Value::Value (CppString n, const Array &val)
{
   arrayVal = new Array(val);
   name = n;
}
...
ULXR_API_IMPL0 Value::Value (CppString n, const Struct &val)
{
   structVal = new Struct(val);
   name = n;
}
...
ULXR_API_IMPL0 Value::Value (CppString n, const RpcString &val)
{
   stringVal = new RpcString(val);
   name = n;
}
...
ULXR_API_IMPL0 Value::Value (CppString n, const Base64 &val)
{
   base64Val = new Base64(val);
   name = n;
}
...
ULXR_API_IMPL0 Value::Value (CppString n, const DateTime &val)
{
   dateVal = new DateTime(val);
   name = n;
}

ULXR_API_IMPL(CppString) Value::getValueName() const
{
	return name;
}
ULXR_API_IMPL(void) Value::setValueName(CppString n)
{
	name = n;
}
...
ULXR_API_IMPL(CppString) Struct::getXml(int indent) const
{
  ...
  for (Members::const_iterator it = val.begin(); it != val.end(); ++it)
  {
    ...
    s += (*it).second.getXml(indent + 2) + getXmlLinefeed();
    //s += ind2 + ULXR_PCHAR("</member>") + getXmlLinefeed();
  }
